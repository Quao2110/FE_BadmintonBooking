  ...
  Widget build(BuildContext context) {
    return AdminLayout(
      ...
      child: BlocProvider(
        create: (_) =>
            ProductBloc.create()
              ..add(GetProductsEvent(ProductListQuery())),
                                  ...
                                  cells: [
                                    ...
                                    DataCell(
                                      Text(
                                        ...
                                        style: TextStyle(
                                          color: product.categoryName == null
                                              ? Colors.grey
                                              : null,
                                        ),
                                      ),
  ...
  void _showDeleteDialog(BuildContext context, ProductEntity product) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('Bạn có chắc muốn xóa sản phẩm "${product.productName}"?'),
        actions: [
          TextButton(
                ...
                Container(
                  ...
                  child: product.imageUrl != null
                      ? ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: Image.network(
                            ApiConstants.getFullImageUrl(product.imageUrl!),
                            fit: BoxFit.cover,
